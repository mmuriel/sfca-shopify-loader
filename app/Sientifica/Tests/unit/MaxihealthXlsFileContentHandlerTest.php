...
class MaxihealthXlsFileContentHandlerTest extends TestCase {

    private $normalizedContent;

	public function setUp():void{
        parent::setUp();
        $contentNormalizer = new MaxihealthXlsFileContentNormalizer();
        $this->normalizedContent = $contentNormalizer->normalizeFileContent(base_path()."/app/Sientifica/Docs/product_data-2022-07-12_01-14-26.xls");
    }
	...
	public function testLastRecordInFileHasNoSubtitle(){
        $contentHandler = new MaxihealthXlsFileContentHandler();
